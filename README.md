# re-region-etl
Dockerized ETL CLI tool to load source data for re-region-api (https://github.com/Matthew-Curry/re-region-api) into a Postgres DB from US census API and excel files produced by the Tax Foundation.
